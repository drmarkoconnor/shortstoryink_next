...
export default function Page() {
 return <GuideShell activeHref="/guide/new-writers">
  ...
  <aside className="guide-next"><p className="studio-eyebrow">A little more context</p><h2 className="literary-title mt-4 text-3xl">What happens on your editor’s desk?</h2><p className="mt-5 max-w-[60ch] text-base leading-8 text-studio-muted">See how private reading becomes published feedback, and how supporting notes are prepared.</p><Link href="/guide/new-writers/how-feedback-works" className="studio-secondary mt-6">See how feedback works →</Link></aside>
 </GuideShell>
}
